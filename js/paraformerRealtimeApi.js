class ParaformerRealtime {
    ...
    connect(callback) {
        return new Promise((resolve, reject) => {
            ...
            this.socket.onopen = () => {
                ...
                console.log('send runTaskMessage: ', runTaskMessage)
            };
    ...
    stop() {
        ...
        console.log('send finishTaskMessage: ', finishTaskMessage)
